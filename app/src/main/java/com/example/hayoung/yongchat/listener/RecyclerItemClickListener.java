package com.example.hayoung.yongchat.listener;
...
/**
 * Created by hayoung on 2017. 11. 7..
 */
        ...
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (child != null && mOnItemClickListener != null) {
                    mOnItemClickListener.onLongItemClick(child, recyclerView.getChildAdapterPosition(child));
                }
            }
        });
    }
